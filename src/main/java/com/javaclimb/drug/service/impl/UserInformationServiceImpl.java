...
import com.javaclimb.drug.mapper.UserInformationMapper;
...
public class UserInformationServiceImpl implements UserInformationService {
    ...
    @Override
    public IPage<UserInformation> getPageList(int pageNum, int pageSize, String param) {
        QueryWrapper<UserInformation> queryWrapper=new QueryWrapper<>();
        if (param!=null){
            queryWrapper.like("user_id",param);
        }
        Page<UserInformation> page=new Page<>(pageNum,pageSize);
        Page<UserInformation> userInformationPage = userInformationMapper.selectPage(page, queryWrapper);
        return userInformationPage;
    }
